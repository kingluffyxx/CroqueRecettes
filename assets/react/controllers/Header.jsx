      ...
      <div className={`${ user ? "px-4 py-4" : "mx-auto px-4 py-4 container" }`}>
        <div className="flex justify-between items-center">
          ...
          <div className="space-x-4">
            {user ? (
            <>
              <span className="mr-4">Bonjour &nbsp;
                <a href="/dashboard">{user}</a>
              </span>
              <a href="/logout" className="text-gray-700 hover:text-indigo-600">
                Déconnexion
              </a>
            </>
          ) : (
            <>
              <a href="/login" className="px-4 py-2 text-gray-600 hover:text-gray-800 transition-colors">
                Connexion
              </a>
              <a href="/register" className="px-4 py-2 rounded-lg btn btn-primary">
                Inscription
              </a>
            </>
          )}
